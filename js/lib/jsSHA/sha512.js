import { jsSHABase, TWO_PWR_32, H_trunc, H_full, K_sha2, sha_variant_error, parseInputOption } from "jsSHA/common";
import { getStrConverter } from "jsSHA/converters";
import { ch_64, gamma0_64, gamma1_64, Int_64, maj_64, safeAdd_64_2, safeAdd_64_4, safeAdd_64_5, sigma0_64, sigma1_64, } from "jsSHA/primitives_64";
const K_sha512 = [
 ...
 */
function finalizeSHA512(remainder, remainderBinLen, processedBinLen, H, variant) {
    let i, retVal;
