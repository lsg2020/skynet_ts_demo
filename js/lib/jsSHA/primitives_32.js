 ...
 */
export function parity_32(x, y, z) {
    return x ^ y ^ z;
}
/**
 ...
 */
export function safeAdd_32_2(a, b) {
    const lsw = (a & 0xffff) + (b & 0xffff), msw = (a >>> 16) + (b >>> 16) + (lsw >>> 16);
 ...
 */
export function safeAdd_32_4(a, b, c, d) {
    const lsw = (a & 0xffff) + (b & 0xffff) + (c & 0xffff) + (d & 0xffff), msw = (a >>> 16) + (b >>> 16) + (c >>> 16) + (d >>> 16) + (lsw >>> 16);
    return ((msw & 0xffff) << 16) | (lsw & 0xffff);
}
/**
 ...
 */
export function safeAdd_32_5(a, b, c, d, e) {
    const lsw = (a & 0xffff) + (b & 0xffff) + (c & 0xffff) + (d & 0xffff) + (e & 0xffff), msw = (a >>> 16) + (b >>> 16) + (c >>> 16) + (d >>> 16) + (e >>> 16) + (lsw >>> 16);
    return ((msw & 0xffff) << 16) | (lsw & 0xffff);
}
/**
