...
export async function read_request(readbytes, bodylimit) {
...
export function write_response(writefunc, statuscode, bodyfunc, header) {
    ...
    if (t == "string") {
        writefunc(`content-length: ${bodyfunc.length}\r\n\r\n`);
        writefunc(bodyfunc);
    }
    else if (t == "function") {
